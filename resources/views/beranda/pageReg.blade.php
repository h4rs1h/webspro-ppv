            ...
            <div class="row">
                ...
                <div class="col-sm-3">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h5 class="card-title"><strong>Invoice:&nbsp;&nbsp; #{{ $tagihan->no_formulir }}</strong></h5>
                            <p>
                            ...
                            <div class="accordion" id="accordionPanelsStayOpenExample">
                                ...
                                <div id="panelsStayOpen-collapseOne" class="accordion-collapse collapse show" aria-labelledby="panelsStayOpen-headingOne">
                                    <div class="accordion-body">
                                        <a href="/viewinvoice/midtrans?no_inv={{ $tagihan->no_formulir }}&uid={{ $tagihan->pelanggan_id }}" class="btn btn-primary">Proses Pembayaran</a>
                                       <br>
							...
							<div class="accordion-item">
                                ...
                                <div id="panelsStayOpen-collapseOne" class="accordion-collapse collapse show" aria-labelledby="panelsStayOpen-headingOne">
                                    ...
                                    @endif
                                        ...
                                        No. Rekening: 4899 77 2005<br>
                                        <br>
                                        Catatan : Setelah mengunggah bukti transfer, Tim Billing kami akan memverifikasi pembayaran Anda maksimal 1 x 24 jam<br>No. Referensi: {{ $tagihan->no_formulir }}</p>
                                    </div>
                                  </div>
                                </div>
                              </div>
                        ...
                        <div class="card-body">
                            <table class="table">
                                ...
                                <tr>
                                    ...
                                    <td align="right" >
                                     <strong>{{ number_format($gttagihan) }}</strong>
                                    </td>
                                </tr>
                            </table>
                        </div>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body text-center">
                            ...
                            <p><a href="/viewinvoice/download?no_order={{ $tagihan->no_order }}&uid={{ $tagihan->pelanggan_id }}" class="btn btn-primary" >download</a></p>
...
<div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog">
        ...
        <form method="post" action="/viewinvoice/tambah-daftar" class="mb-5" enctype="multipart/form-data">
            @csrf
                    ...
                    <div class="col-lg-12">
                        <div class="row">
                            <div class="col-lg-12">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <label>No Invoice Pendaftaran</label>
                                        </div>
                                        <div class="col-md-8">
                                            <input type="text" class="form-control" disabled name="no_tagihan" id="no_tagihan" value="{{ $tagihan->no_formulir }}">
                                            ...
                                            <input type="hidden" name="trx_order_id" id="trx_order_id" value="{{ $inv->id }}">
                                            <input type="hidden" name="no_formulir" id="no_formulir" value="{{ $inv->no_formulir }}">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-4">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <input type="text" class="form-control" disabled name="gtot_tagihan" id="gtot_tagihan" value="{{ number_format($gttagihan) }}">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-4">
