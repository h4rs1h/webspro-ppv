                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body text-center">
                            ...
                            Silahkan hubungi kami jika butuh bantuan, melalui <br>Whatsapp : 0857-2732-2732 atau datang langsung ke unit AAA/L1/16
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="col-lg-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            ...
                                            <input type="number" class="form-control @error('nominal_bayar') is-invalid  @enderror" id="nominal_bayar" required autofocus  name="nominal_bayar" value="{{ old('nominal_bayar') }}">
                                                @error('nominal_bayar')
                                                    <div class="invalid-feedback"  role="alert">
                                                        <strong>
                                                            {{ $message }}
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            ...
                                            <input type="file" class="form-control"  required autofocus  name="image" id="image">
											@if ($errors->has('image'))
