...
<div class="container-fluid">
    ...
    <div class="col-lg-12">
        ...
        <div class="row">
            <div class="col-lg-12">
                <form method="post" action="/admin/trx_order/cuti/getTotal" class="mb-5" enctype="multipart/form-data">
                    @csrf
                                            ...
                                            <div class="panel-body">
												...
												<div class="row">
                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="col-md-3">
                                                            {{--  <input class="form-control" type="date">  --}}
                                                            <input type="text" class="form-control text-left @error('lama_cuti') is-invalid  @enderror" id="lama_cuti" name="lama_cuti" autofocus value="{{ old('lama_cuti') }}">
                                                        </div>
                                                        <div class="col-md-3">
                                                            <label> Bulan</label>
                                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="panel-body">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="col-md-6">
                                                            <label>Mulai Cuti Tanggal </label>
                                                        </div>
                                                        <div class="col-md-5">
                                                            {{--  <input class="form-control" type="date">  --}}
                                                    ...
                                                    <thead>
                                                     ...
                                                     <tbody>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <input type="hidden" name="id_biaya" id="id_biaya" value="{{ $d->id }}">
                                                                <input type="text" class="form-control text-left @error('ly_biaya_cuti') is-invalid  @enderror" id="ly_biaya_cuti" name="ly_biaya_cuti" autofocus readonly value="{{ old('ly_biaya_cuti',$d->title) }}">
                                                            </td>
                                                            <td class="text-right">
                                                                <input type="text" class="form-control text-right @error('hrg_int') is-invalid  @enderror" id="hrg_int" name="hrg_int" autofocus readonly value="{{ old('hrg_int',$d->harga) }}">
                                                            </td>
                                                            ...
                                                            <td class="text-right">
                                                                <input type="number" class="form-control text-right @error('promo_int') is-invalid  @enderror" id="promo_int" name="promo_int" readonly autofocus  value="{{ old('promo_int') }}">
                                                            </td>
                                                            <td class="text-right">
...
<script src="{{ asset('js/trxordercuti.js') }}"></script>
@endsection
