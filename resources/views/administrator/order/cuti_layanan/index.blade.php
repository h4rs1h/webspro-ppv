    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            <div class="panel-heading">
                <a href="/admin/trx_order/cuti/create" class="btn btn-primary mb-3">Tambah Data Pelanggan Cuti Langganan</a>
                        ...
                        <tbody>
                            @foreach ($order as $data )
                                <tr>
                                    ...
                                    <td>
										{{-- <a href="/admin/trx_order/upgrade/getAksi?aksi=show&id={{ $data->id }}" class="text-decoration-none">
                                        {{ $data->no_formulir }}</a>--}}
										{{ $data->no_formulir }}
									</td>
