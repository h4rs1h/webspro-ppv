                    ...
                    <td width="60%">
                        <table border="1">
                            <tr>
                                ...
                                <td><div align="right">
                                    {{ $no_tagihan }}<br>
                                    {{ $no_pelanggan }} - ({{ $no_unit }})<br>
                                    {{ $termin }}<br>
                                    {{ Carbon\Carbon::parse($tgl_tagih)->format('d-M-Y')  }}<br>
                                    {{ Carbon\Carbon::parse($tgl_jt_tempo)->format('d-M-Y')  }}<br>
                ...
                <tr class="item">
                    <td colspan="2">
                        <table>
                            ...
                            <tr>
                                <td>PPn 11%</td>
                                <td><div align="right">{{ number_format($ppn_) }}</div> </td>
                            </tr>
                            <tr>
                                <td>
                                    Tagihan
                                ...
                                <td>
                                    <div align="right">{{ number_format($subtagihan+$ppn_) }}</div>
                                </td>
                            </tr>
                            <tr>
                                <td>
