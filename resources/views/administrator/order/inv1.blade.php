...
@php
    ...
    $ppnRate = SettingHelper::getPpn($order->tgl_order);
@endphp
...
<body>
    <div class="invoice-box">
        <table cellpadding="0" cellspacing="0">
            ...
            <tr class="item">
                <td width="59%">
                    <div align="center"><strong>Nomor: {{ $order->no_formulir }}</strong></div>
                </td>

                <td width="41%">
                    <div align="left"><strong>Tanggal:
                            {{ Carbon\Carbon::parse($order->tgl_order)->format('d-M-Y') }}</strong></div>
                </td>
            </tr>
            <tr class="heading">
                <td>
                ...
                <td colspan="2">
                    <table border="1" class="details">
                        ...
                        <tr class="item">
                            ...
                            <td width="32%">
                                {{ $order->pelanggan->sub_tower . '/' . $order->pelanggan->lantai . '/' . $order->pelanggan->nomer_unit }}
                            </td>
                            <td width="36%"><span>Status Pemilik / Penyewa</span> </td>
                        </tr>
                        <tr class="item">
                            <td class="item"><span>Alamat Sesuai KTP</span></td>
                            <td colspan="2">{{ $order->pelanggan->alamat_identitas }}</td>
                        </tr>
                        <tr class="item">
                ...
                <td colspan="2">
                    <table border="1" class="item">
                        <tr class="heading">
                            ...
                            <td>
                                <div align="center">Harga Layanan</div>
                            </td>
                            <td>
                                <div align="center">Periode</div>
                            </td>
                            <td>
                                <div align="center">Promo/Diskon</div>
                            </td>
                            <td>
                        ...
                        @foreach ($order_dtl as $data)
                            @if (($data->layanan_id != '10') & ($data->layanan_id != '11'))
                                <tr class="item">
                                    <td>{{ $data->title }}</td>
                                    <td>
                                        <div align="right">{{ number_format($data->amount) }}</div>
                                    </td>
                            ...
                            @elseif($data->layanan_id == '10')
                                <tr>
                                    ...
                                    <td>
                                        <div align="right">{{ number_format($data->sub_amount - $data->tax_amount) }}
                                        </div>
                                    </td>
                                </tr>
                            @elseif($data->layanan_id == '11')
                                ...
                                $ppndeposit = $data->sub_amount * ($ppnRate / 100);
                                ?>
                            @endif
                            <?php
                        ...
                        <span class="style16">
                            <p style="line-height:15px">
                                *Deposit akan dikembalikan 14 (Empat Belas) hari setelah langganan berakhir.<br>
                                Promo berlaku untuk 1 periode</p>
                        </span></span>
                </td>
                <td>
                    <table border="1">
                        <tr class="item">
                            <td width="54%">
                                <div align="left">PPN {{ $ppnRate }}%</div>
                            </td>
                            <td width="46%">
                                <div align="right">{{ number_format($ppn) }}</div>
                            </td>
                        </tr>
                        {{--  <tr class="item">
                        ...
                        <tr class="item">
                            <td>
                                <div align="left"><strong>GRAND TOTAL</strong></div>
                            </td>
                            <td>
                                <div align="right">{{ number_format($gtot_amount + $ppn) }}</div>
                            </td>
                        </tr>
                    </table>
                </td>
                ...
                <td colspan="2">
                    <table>
                        <tr>
                            ...
                            <td width="50%">
                                <div align="center">Disetujui Oleh:<br>PT. Media Prima Jaringan</div>
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            <td colspan="2">
                                <span class="style18">
                                    <p style="line-height:15px">
                                        - Layanan Internet di Apartemen Puri Parkview adalah bentuk kerjasama antara PT.
                                        Media Prima Jaringan dengan PT. Mora Telematika Indonesia (Moratelindo) sebagai
                                        ekslusif ISP dengan merek layanan yaitu Oxygen.id<br>
                                        - Layanan Fixed Telephony di Apartemen Puri Parkview yang disediakan merupakan
                                        bentuk Kerjasama antara PT. Smartfren Telecom Tbk. dengan PT. Mora Telematika
                                        Indonesia (Moratelindo)</p>
                                </span>
                            </td>
                        </tr>
                    </table>
