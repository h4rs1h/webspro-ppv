                        ...
                        <div class="col-lg-12">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body text-center">
                                    <a class="btn btn-primary" href="/admin/trx_order/stop/getAksi?aksi=print&id={{ $order->id }}">  Lembar PPn</a>
                                    <a class="btn btn-primary" href="/admin/trx_order/stop/getAksi?aksei=print-non-ppn&id={{ $order->id }}">  Lembar Non PPn</a>
                                    @if($tunggakan>0)
