    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            <div class="panel-heading">
                <a href="/admin/trx_order/stop/create" class="btn btn-primary mb-3">Tambah Data Pelanggan Stop Layanan</a>
                        ...
                        <tbody>
                            @foreach ($order as $data )
                                <tr>
                                    ...
                                    <td><a href="/admin/trx_order/stop/getAksi?aksi=show&id={{ $data->id }}" class="text-decoration-none">
