...
<div class="container-fluid">
    ...
    <div class="col-lg-12">
        ...
        <div class="row">
            <div class="col-lg-12">
                <form method="post" action="/admin/trx_order/stop/getTotal" class="mb-5" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="col-lg-12">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-heading col-md-6">
                                    Request Stop Layanan Pelanggan
                                </div>
                                <div class="panel-heading col-md-6">
                                    Estimasi Stop Layanan
                                </div>
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="col-md-6">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="table-responsive">
                                                ...
                                                <button type="submit" class="btn btn-primary" name="simpan" id="simpan">Hitung Total</button>
