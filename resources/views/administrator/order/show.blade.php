                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        <div class="col-lg-12">
											...
											<label>Termin Pembayaran : {{ number_format($order_ppn->termin_bayar) }} kali cicilan</label>
                                        </div>
										
                                    </div>
                                </div>
                                <div class="panel-body text-center">
                                    <a class="btn btn-primary" href="/admin/trx_order/download/{{ $order->id }}">  Lembar PPn</a>
                                    <a class="btn btn-primary" href="/admin/trx_order/do_non_ppn/{{ $order->id }}">  Lembar Non PPn</a>
									 @if($tunggakan>0)
                                        <a class="btn btn-primary" href="/admin/trx_order/inv_tagihan_daftar/{{ $order->id }}">  Lembar Format Invoice Cicilan</a>
									<a class="btn btn-primary" href="/admin/trx_order/inv_full_tagihan_daftar/{{ $order->id }}">  Lembar Format Invoice Full</a>
                                    @endif
                                </div>
                                <!-- /.panel-body -->
                            </div>
