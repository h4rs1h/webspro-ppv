...
<body>
		<div class="invoice-box">
			<table cellpadding="0" cellspacing="0">
					...
					<td colspan="2" class="mt-0 mb-0">
						<table class="top mt-0 pt-0">
							<tr>
								<td width="35%">
                                    <div align="center">
                                        <img src="{{ asset('asset/images/LOGO1.png') }}" width="160" height="90"><br>
                                    </div>
                                </td>
								<td width="40%">
                                ...
                                <td width="25%">
                                    <div align="center"><img src="{{ asset('asset/images/LOGO2.png') }}" width="165" height="65"><br>
                                    </div>
                                </td>
							</tr>
						</table>
				...
				<tr class="heading" >
					<td colspan="2">
                        <div align="center" >Formulir Downgrade Layanan Pelanggan</div>
                    </td>
				</tr>
				<tr class="item">
                        ...
                        <table border="1" class="item">
                            ...
                            @foreach ($order_dtl as $data )
                                ...
                                <tr>
                                    ...
                                    <td ><div align="right">{{ number_format($data->sub_amount-$data->tax_amount) }}</div></td>
                                </tr>
				...
				<tr class="items">
                    <td>
                        ...
                        Catatan: <br>
                            <ol>
                                @if($order->metode_bayar=="2")
                                    <li>
                                        Pembayaran Bertahap selama: $order->termin_bayar
                                    </li>
                                @endif
                                @if ($order->catatan1)
                                    <li>{{ $order->catatan1 }}</li>
                                @endif
                                @if ($order->catatan2)
                                    <li>{{ $order->catatan2 }}</li>
                                @endif
