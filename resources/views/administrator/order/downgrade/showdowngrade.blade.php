                        ...
                        <div class="col-lg-12">
                            <div class="panel panel-default">
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-striped table-bordered table-hover">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td colspan="5" class="text-right">Deposti </td>
                                ...
                                <div class="panel-body text-center">
                                    <a class="btn btn-primary" href="/admin/trx_order/downgrade/getAksi?aksi=print&id={{ $order->id }}">  Lembar PPn</a>
                                    <a class="btn btn-primary" href="/admin/trx_order/downgrade/getAksi?aksei=print-non-ppn&id={{ $order->id }}">  Lembar Non PPn</a>
                                    @if($tunggakan>0)
