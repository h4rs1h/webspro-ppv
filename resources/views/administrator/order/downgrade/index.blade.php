    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            <div class="panel-heading">
                <a href="/admin/trx_order/downgrade/create" class="btn btn-primary mb-3">Tambah Data Downgrade</a>
                        ...
                        <tbody>
                            @foreach ($order as $data )
                                <tr>
                                    ...
                                    <td><a href="/admin/trx_order/downgrade/getAksi?aksi=show&id={{ $data->id }}" class="text-decoration-none">
