...
<div class="container-fluid">
    ...
    <div class="col-lg-12">
        ...
        <div class="row">
            <div class="col-lg-12">
                <form method="post" action="/admin/trx_order/downgrade/getTotal" class="mb-5" enctype="multipart/form-data">
                    @csrf
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="table-responsive">
                                                ...
                                                <button type="submit" class="btn btn-primary" name="simpan" id="simpan">Hitung Total Downgrade</button>
