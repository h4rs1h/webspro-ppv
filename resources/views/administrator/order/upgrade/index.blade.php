    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            <div class="panel-heading">
                <a href="/admin/trx_order/upgrade/create" class="btn btn-primary mb-3">Tambah Data Upgrade</a>
                        ...
                        <tbody>
                            @foreach ($order as $data )
                                <tr>
                                    ...
                                    <td><a href="/admin/trx_order/upgrade/getAksi?aksi=show&id={{ $data->id }}" class="text-decoration-none">
