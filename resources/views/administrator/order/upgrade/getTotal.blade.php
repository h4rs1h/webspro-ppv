...
<div class="container-fluid">
    ...
    <div class="col-lg-12">
        ...
        <div class="row">
            <div class="col-lg-12">
                <form method="post" action="/admin/trx_order/upgrade/Simpan" class="mb-5" enctype="multipart/form-data">
                    @csrf
                                                     ...
                                                     <tbody>
                                                        <tr>
														 ...
														 <tr>
                                                            ...
                                                            <td>
                                                                <select class="form-control" name="ly_tv" id="ly_tv" readonly>
                                                                    <option value="" >-- Pilih --</option>
                                                                    @foreach ($tv as $d)
                                                            ...
                                                            <td class="text-center">
                                                                <input type="number" class="form-control text-center @error('qty_tv') is-invalid  @enderror" id="qty_tv" name="qty_tv" required autofocus value="{{ old('qty_tv',$qty_tv) }}" >
                                                            </td>
                                                            <td class="text-right">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-right">
                                                                <input type="text" class="form-control text-right @error('deposit') is-invalid  @enderror" id="deposit" name="deposit"  autofocus value="{{ old('deposit',$deposit) }}">
                                                            </td>
                                                        </tr>
                                                        <tr>
