                    ...
                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                        <thead>
                            <tr>
                                ...
                                <th scope="col">Tanggal Formulir</th>
                        ...
                        <tbody>
                            @foreach ($outstd as $data )
                                <tr>
                                    ...
                                    <td>{{ number_format($data->bayar_amount) }}</td>
                                    <td>{{ number_format($data->outstanding) }}</td>
                                    <td>
                                        <a href="/admin/trx_bayar/bayar?no_order={{ $data->no_order }}&tipe_order={{ $data->tipe_order }}" class="btn btn-primary btn-circle" data-toggle="tooltip" data-placement="top" title="Proses Pembayaran">
                                            <i class="fa fa-paypal"></i>
                                        </a>
                                      {{--  <a href="/admin/trx_bayar/bayar/{{ $data->no_order }}" class="btn btn-primary btn-circle" data-toggle="tooltip" data-placement="top" title="Proses Pembayaran">
