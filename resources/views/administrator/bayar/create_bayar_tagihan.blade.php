...
<div class="container-fluid">
    ...
    <div class="col-lg-12">
        ...
        <div class="row">
            <div class="col-lg-12">
                <form method="post" action="/admin/trx_bayar/bayar_tagihan" class="mb-5" enctype="multipart/form-data">
                    @csrf
                                                ...
                                                <table>
                                                    <tr>
                                                        ...
                                                        <td class="col-md-2" >
                                                            ...
                                                            <input type="hidden" id="trx_tagihan_id" name="trx_tagihan_id" value="{{ $orderhdr->id }}">
													...
													<tr>
                                                        ...
                                                        <td>:</td>
                                                        <td class="col-md-3" >
                                                            <input type="text" class="form-control @error('biaya_transaksi') is-invalid  @enderror" id="biaya_transaksi" name="biaya_transaksi" required autofocus value="{{ old('biaya_transaksi') }}">
                                                ...
                                                <table >
                                                    <tr>
                                                        ...
                                                        <td class="col-md-8" colspan="3">
                                                            <input type="text" class="form-control @error('no_formulir') is-invalid  @enderror" id="no_formulir" name="no_formulir" disabled required autofocus value="{{ old('no_formulir',$orderhdr->no_tagihan) }}">
                                                            @error('no_formulir')
                                                                <div class="invalid-feedback text-danger" role="alert">
                                                                    {{ $message }}
                                                                </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>:</td>
                                                        <td class="col-md-8" colspan="3">
                                                            <input class="form-control " readonly value="{{ date('d-m-Y', strtotime($orderhdr->tgl_tagihan)) }}" name="tgl_tagihan" id="tgl_tagihan">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>:</td>
                                                        <td class="col-md-3" >
                                                            <input type="text" class="form-control @error('tgl_jatuh_tempo') is-invalid  @enderror" id="tgl_jatuh_tempo" name="tgl_jatuh_tempo" required autofocus readonly value="{{ date('d-m-Y', strtotime($orderhdr->tgl_jatuh_tempo)) }}">
                                                        </td>
                                                    </tr>
													<tr>
                                                        <td class="col-md-4"><label class="text-md-start">{{ __('Periode Tagihan') }}</td>
                                                        <td>:</td>
                                                        <td class="col-md-3" >
                                                            <input type="text" class="form-control @error('periode_pemakaian') is-invalid  @enderror" id="periode_pemakaian" name="periode_pemakaian" required autofocus readonly value="{{ $orderhdr->periode_pemakaian }}">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>:</td>
                                                        <td class="col-md-8" colspan="3">
                                                            <input type="text" class="form-control @error('total_tagihan') is-invalid  @enderror" id="total_tagihan" name="total_tagihan" required autofocus readonly value="{{ old('total_tagihan',number_format($orderhdr->gtot_tagihan)) }}">
                                                        </td>
                                                    </tr>
                                                </table>
                                            </div>
