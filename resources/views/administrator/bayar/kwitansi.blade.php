...
<body>
		<div class="invoice-box">
			<table cellpadding="0" cellspacing="0">
				...
				<tr class="heading" >
					<td colspan="2">
                        <div align="center" >KWITANSI PEMBAYARAN</div>
                    </td>
				</tr>
				<tr class="item">
                    <td colspan="2">
                        ...
                        <table border="1">
                            ...
                            @foreach ($order_dtl as $data )
                                <tr>
                                    ...
                                    <td>{{ $data->title }}</td>
                                    <td ><div class="text-right">Rp {{ number_format($data->payment_amount) }}</div></td>
                                </tr>
                            @endforeach
                            <tr class="total">
                    ...
                    <td colspan="2">
                        <table>
                            <tr>
                                ...
                                <td  width="2%">:</td>
                                <td  width="15%">Rp  @if ($bayar->status_bayar=='1')
                                ...
                                <td  width="2%"></td>
                                <td  >Perhatian: </td>
                                <td  width="15%">{{ Carbon\Carbon::parse( $bayar->tgl_bayar)->format('d-M-Y') }}</td>
                            </tr>
                            <tr>
