        ...
        <div class="col-lg-12">
            <div class="penel panel-default">
                ...
                <div class="penel-body">
                    <div class="row">
                        <form method="post" action="/admin/pelanggan" class="mb-5" enctype="multipart/form-data">
                        @csrf
                        <div class="col-lg-6">
                                ...
                                <div class="form-group">
                                    <label for="nomer_hp" >{{ __('Nomer HP Utama') }}</label>
                                        ...
                                        <input type="number" class="form-control @error('nomer_hp') is-invalid  @enderror" id="nomer_hp" name="nomer_hp" required autofocus value="{{ old('nomer_hp') }}">
                                        @error('nomer_hp')
                                            <div class="alert alert-danger" role="alert">
                                                <strong> {{ $message }}</strong>
                                            </div>
                                ...
                                <div class="form-group">
                                    <label for="nomer_hp2" >{{ __('Nomer HP ') }}</label>
                                        ...
                                        <input type="number" class="form-control @error('nomer_hp2') is-invalid  @enderror" id="nomer_hp2" name="nomer_hp2" autofocus value="{{ old('nomer_hp2') }}">
                                        @error('nomer_hp2')
                                            <div class="alert alert-danger" role="alert">
                                                <strong> {{ $message }}</strong>
                                            </div>
                                ...
                                <div class="form-group">
                                    <label for="alamat_identitas" >{{ __('Alamat Sesuai (KTP/SIM/PASPORT)') }} </label>
                                        ...
                                        <input type="text" class="form-control @error('alamat_identitas') is-invalid  @enderror" id="alamat_identitas" name="alamat_identitas" required autofocus value="{{ old('alamat_identitas') }}">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="form-group">
                                    <label for="nomer_identitas" >{{ __('Nomer Identitas') }} </label>
                                        ...
                                        <input type="text" class="form-control @error('nomer_identitas') is-invalid  @enderror" id="nomer_identitas" name="nomer_identitas" required autofocus value="{{ old('nomer_identitas') }}">
                                ...
                                <div class="form-group">
                                    <label for="nomer_unit" >{{ __('Nomor Unit') }}</label>
                                        ...
                                        <input type="text" class="form-control @error('nomer_unit') is-invalid  @enderror" id="nomer_unit" name="nomer_unit" required autofocus value="{{ old('nomer_unit') }}">
                                        @error('nomer_unit')
                                            <div class="alert alert-danger" role="alert">
                                                <strong> {{ $message }}</strong>
                                            </div>
