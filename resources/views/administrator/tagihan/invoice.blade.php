            ...
            <tr class="item">
                <td colspan="2">
                    <table>
                        <tr>
                            <td>
                                <h3>Tagihan Sebelumnya<br>
                                    Pembayaran Sebelumnya</h3>
                            </td>
                            <td>&nbsp;</td>
                        </tr>
                        ...
                        <tr>
                            <td>PPn 11%</td>
                            <td>
                                <div align="right">{{ number_format($tagihan->ppn_tagihan) }}</div>
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <div align="right">
                                    <h3>{{ number_format($tagihan->gtot_tagihan) }}</h3>
                                </div>
                            </td>
                        </tr>
                    </table>
            ...
            <tr class="items">
                <td colspan="2">
                    <ul>
                        ...
                        <li>
                            Masa aktif layanan Anda sesuai dengan periode berlangganan akan berakhir pada jam 00.000 WIB
                            akhir periode
                        </li>
                        <li>
            ...
            <tr>
                <td colspan="2">
                    <i>
                        ...
                        Layanan Internet di Apartemen Puri Parkview adalah bentuk kerjasama antara PT. Media Prima
                        Jaringan dengan PT. Mora Telematika Indonesia (Moratelindo) sebagai ekslusif ISP dengan merek
                        layanan yaitu Oxygen.id<br>
                    </i>
                </td>
            </tr>
        </table>
