...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane fade active in" id="home">
                                <form method="post" action="/admin/trx_invoice/getdata" class="mb-5"
                                                ...
                                                <div class="panel-body">
                                                    <div class="row">
                                                        <div class="col-lg-12">
                                                            <div class="col-md-4">
                                                                <label
                                                                    class="text-md-start">{{ __('Pilih Filter') }}</label>
                                                            </div>
                                                            <div class="col-md-8">
                                                                <input type="hidden" name="penel" id="penel"
                                                                    value="0">
                                                                <select class="form-control" name="statuspelanggan"
                                                                    id="statuspelanggan">
                                                            ...
                                                            <div class="col-md-8">
                                                                <input class="form-control " name="input_filter"
                                                                    id="input_filter">
                                                                <label
                                                                    for="tgl_jtempo">{{ __('Tanggal Jatuh Tempo harus diisi sesuai dengan format tahun-bulan-tanggal. Contoh (2022-07-31).') }}</label>
                                                            </div>
                                                            <div class="col-md-4">
                                                            </div>
                                                            <div class="col-md-8">
                                                ...
                                                <div class="panel-body">
                                                    <div class="row">
                                                        <div class="col-lg-12">
                                                            <div class="col-md-4">
                                                                <label
                                                                    class="text-md-start">{{ __('Dari Tanggal ') }}</label>
                                                            </div>
                                                            <div class="col-md-8">
                                                                <input type="hidden" name="penel" id="penel"
                                                                    value="1">
                                                            ...
                                                            <div class="col-md-4">
                                                                <label
                                                                    class="text-md-end">{{ __('Sampai Tanggal ') }}</label>
                                                            </div>
                                                            <div class="col-md-8">
                                                                <input type="date"
                                                                    class="form-control @error('tgl_akhir') is-invalid  @enderror"
                                                                    id="tgl_akhir" name="tgl_akhir" required
                                                                    value="{{ old('tgl_akhir') }}">
                                                                @error('tgl_akhir')
                                                                    <div class="invalid-feedback" role="alert">
                                                                        <strong>
                                                            ...
                                                            <div class="col-md-4">
                                                                <label
                                                                    class="text-md-start">{{ __('Status Tagihan') }}</label>
                                                            </div>
                                                            <div class="col-md-8">
                                                                <select class="form-control" name="statustagihan"
                                                                    id="statustagihan">
                                                                    <option value="">-- Pilih --</option>
                                                            ...
                                                            <div class="col-md-4">
                                                                <label
                                                                    class="text-md-end">{{ __('Filter Pelanggan') }}</label>
                                                            </div>
                                                            <div class="col-md-8">
                                                                <select class="form-control" name="statuspelanggan"
                                                                    id="statuspelanggan">
                                                            ...
                                                            <div class="col-md-4">
                                                                <label
                                                                    class="text-md-end">{{ __('Input Filter') }}</label>
                                                            </div>
                                                            <div class="col-md-8">
                                                                <input class="form-control " name="input_filter"
                                                                    id="input_filter">
            ...
            {{--  kolom  --}}
            @if (in_array(Auth::user()->id, [1, 12, 37, 63]))
                <div class="col-lg-6">
                    <div class="panel panel-default">
                        <div class="panel-heading ">
                        ...
                        <div class="penel-body">
                            <div class="row">
                                <div class="col-lg-12">
                                    <form method="post" action="/admin/trx_invoice/cek_expdate" class="mb-5"
                                        enctype="multipart/form-data">
                                        @csrf
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    class="form-control @error('unitid') is-invalid  @enderror"
                                                    id="unitid" name="unitid" required autofocus
                                                    value="{{ old('unitid') }}">
                                                @error('unitid')
                                                    <div class="invalid-feedback" role="alert">
                                                        <strong>
                                            ...
                                            <div class="form-group">
                                                <button type="submit" class="btn btn-primary"
                                                    onclick="return confirm('Yakin Cek Data?')">Submit </button>
                                            </div>
                ...
                <div class="col-lg-6">
                    <div class="panel panel-default">
                        ...
                        <div class="penel-body">
                            <div class="row">
                                <div class="col-lg-12">
                                    <form method="post" action="/admin/trx_invoice/upd_invbatal" class="mb-5"
                                        enctype="multipart/form-data">
                                        @csrf
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    id="no_tagihan" name="no_tagihan" required autofocus
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    id="ket" name="ket" required autofocus
                                                    value="{{ old('ket') }}">
                                                @error('ket')
                                                    <div class="invalid-feedback" role="alert">
                                                        <strong>
                                            ...
                                            <div class="form-group">
                                                <button type="submit" class="btn btn-primary"
                                                    onclick="return confirm('Yakin Simpan Data?')">Update Invoice Batal
                                                </button>
                                            </div>
                ...
                <div class="col-lg-6">
                    <div class="panel panel-default">
                        ...
                        <div class="penel-body">
                            <div class="row">
                                <div class="col-lg-12">
                                    <form method="post" action="/admin/trx_invoice/upd_expdateinv" class="mb-5"
                                        enctype="multipart/form-data">
                                        @csrf
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <label for="tgl_jtempo">{{ __('Tanggal Jatuh Tempo') }}</label>
                                                <input type="date"
                                                    class="form-control @error('tgl_jtempo') is-invalid  @enderror"
                                                    id="tgl_jtempo" name="tgl_jtempo" required autofocus
                                                    value="{{ old('tgl_jtempo') }}">
                                                @error('tgl_jtempo')
                                                    <div class="invalid-feedback" role="alert">
                                                        <strong>
                                                            {{ $message }}
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="hidden" name="tipe_form" value="4">
                                                <input type="text"
                                                    class="form-control @error('periode_pemakaian') is-invalid  @enderror"
                                                    id="periode_pemakaian" name="periode_pemakaian" required autofocus
                                                    value="{{ old('periode_pemakaian') }}">
                                            ...
                                            <div class="form-group">
                                                <button type="submit" class="btn btn-primary"
                                                    onclick="return confirm('Yakin Simpan Data?')">Update Exp Date Invoice
                                                </button>
                                            </div>
