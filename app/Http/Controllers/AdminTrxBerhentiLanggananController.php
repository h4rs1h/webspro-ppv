...
class AdminTrxBerhentiLanggananController extends Controller
{
    ...
    public function index()
    {
      //  dd($request);
        ...
        return view('administrator.order.berhenti.index',[
            'order' => TrxOrder::where('tipe_order','6')->get(),
            'level' => $role,
    ...
    public function create()
    {
        ...
        return view('administrator.order.berhenti.create',[
          //  'order' => TrxOrder::all(),
            'level' => $role,
            'title' => 'Tambah Berhenti Langganan Pelanggan',
      ...
      //  dd($request);
        ...
        if($cek=='0'){
            ...
            if(isset($request->ly_tv)){
                ...
                $kurang_deposit = $sub_amount_deposit;
            ...
            return view('administrator.order.berhenti.getTotal',[
                ...
                'level' => $role,
                'title' => 'Berhenti Langganan Pelanggan',
                'no_formulir' => $request->no_formulir,
                'internet' => $internet,
                'tv' => $tv,
                'telepony' => $telepony,
    ...
    public function getSimpan(Request $request){
		...
		return view('administrator.order.berhenti.getSimpan',[
            ...
            'level' => $role,
            'title' => 'Berhasil Simpan Berhenti Langganan Pelanggan',
            'no_formulir' => $request->no_formulir,
            'internet' => $internet,
            'tv' => $tv,
            'telepony' => $telepony,
    ...
    public function getAksi(Request $request)
    {
        ...
        if($request->aksi=="print"){
            ...
            $data["title"] = "Formulir Berhenti Berlangganan Pelanggan";

            //return view('administrator.order.upgrade.invUpgrade1', $data);

             $pdf = PDF::loadView('administrator.order.berhenti.invUpgrade1', $data);
        ...
        //    / return view('administrator.order.upgrade.invUpgrade2', $data);
            ...
            $pdf = PDF::loadView('administrator.order.berhenti.invUpgrade2', $data);
